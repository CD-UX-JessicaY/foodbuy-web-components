...
const FbCheckbox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6198179c490277af847b4a9b09fe13d5ad101d2f' }, index.h("div", { key: '84dc2bd3299205b8e19fdd0cf8b280b8fcdeed9a', class: "fb-checkbox-wrapper" }, index.h("label", { key: 'c94a3214cc105bbe3cddce9d1a6c6df483474802', htmlFor: this.inputId, class: {
            ...
            } }), index.h("span", { key: '970b905201ffcd0d21cf7dbac4976718c889aa30', "aria-hidden": "true", class: {
                'checkbox-box': true,
                [`size-${this.size}`]: true,
            ...
            : this.checked
                ...
                : null), this.label && index.h("span", { key: 'b44fee8790b64ad84beaa596686e72d49f2d3f31', class: "label-text" }, this.label)), hasHelper && (index.h("div", { key: '75be8fb56db5148e081cad513c9634f00ebd1ada', id: this.helperId, class: { 'fb-helper': true, 'fb-helper--error': this.isError }, role: this.isError ? 'alert' : null }, this.helperText)))));
    }
};
...
const FbPagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6f480c0a71e3e08c2cf61f29cf919840181fe833' }, index.h("nav", { key: 'fd8f69dc66b52bce3570ca5ca8cd5fbc165d4160', "aria-label": this.label, class: "fb-pagination" }, index.h("button", { key: '4b6bc042f3a70ef7a29fb8d862a2e4e0c1042ad8', type: "button", class: "page-btn nav-btn", "aria-label": "Go to previous page", disabled: isFirst, "aria-disabled": isFirst ? 'true' : null, onClick: () => this.go(this.currentPage - 1) }, index.h("svg", { key: 'a80527e0568cc48a0dcb5189640bf35880c410a1', "aria-hidden": "true", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: 'b8ebda0f56588f9a26fcdb8deeeb1d015a6cbacf', d: "M15 18l-6-6 6-6" }))), pages.map((page, i) => page === '...'
            ? index.h("span", { key: `ellipsis-${i}`, class: "ellipsis", "aria-hidden": "true" }, "\u2026")
            : (index.h("button", { key: page, type: "button", class: { 'page-btn': true, 'active': page === this.currentPage }, "aria-label": `Go to page ${page}`, "aria-current": page === this.currentPage ? 'page' : null, onClick: () => this.go(page) }, page))), index.h("button", { key: 'a04ea4e40140b486bbf51c9ad246d97d3907f30e', type: "button", class: "page-btn nav-btn", "aria-label": "Go to next page", disabled: isLast, "aria-disabled": isLast ? 'true' : null, onClick: () => this.go(this.currentPage + 1) }, index.h("svg", { key: '451f7d4f785b1e1c6ddbd99c790774b982e8187d', "aria-hidden": "true", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: '0e108eb5675b5398236437daa03cf56df482660f', d: "M9 18l6-6-6-6" }))))));
    }
};
...
const FbPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd97edc9dede6238dd2eee2daf9f9c6ffd271f9ff' }, index.h("span", { key: 'c3956574fa7d4f2b490c955fd784f74f344be776', class: "fb-popover-anchor" }, index.h("button", { key: '810a49e18466ac07a78c68f9421c4c5c6927cce5', id: this.triggerId, type: "button", "aria-haspopup": "dialog", "aria-expanded": this._open ? 'true' : 'false', "aria-controls": this._open ? this.popoverId : null, class: "fb-popover-trigger", onClick: () => this.toggle() }, index.h("slot", { key: 'b95a15b41080c79efd64d0aaa7bb3af977da986f', name: "trigger" }, "Open")), this._open && (index.h("div", { key: '34c3434e9e8e828180a742599459e67a3f803994', id: this.popoverId, role: "dialog", "aria-modal": "false", "aria-label": this.heading || 'Popover', class: `fb-popover fb-popover--${this.placement}`, onKeyDown: this.handleKeyDown }, index.h("div", { key: '873a8276088358fac5acc07813f321a423cd6eae', class: "fb-popover__header" }, this.heading && index.h("span", { key: '97b966e6f384e7c0b4cef4a27e7fa54adcd465eb', class: "fb-popover__heading" }, this.heading), index.h("button", { key: 'ff4e29db1b3b3eda2987c295d29c58380130a37e', type: "button", class: "fb-popover__close", "aria-label": "Close popover", onClick: () => this.closePopover() }, index.h("svg", { key: 'c8dbb1f2ea13b8fde1e8cf657eda630ff57f72b3', "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: '175c89627f9c0b8fbd53e9fa91a21772a851104f', d: "M18 6L6 18M6 6l12 12" })))), index.h("div", { key: 'c8a319c6955a1060e9f8bea1ed1a5e83c4722aaa', class: "fb-popover__body" }, index.h("slot", { key: '97702acb40fa7735868484a1e8deb1acec3fd954' })))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "open": [{
...
const FbRadioGroup = class {
    ...
    render() {
        ...
        const hasHelper = !!this.helperText;
        return (index.h(index.Host, { key: 'c1dcd925bee51b2b16a55b6aec766f752e9dcc75' }, index.h("fieldset", { key: 'e18b0a24b04f2ab486ae75aba16002a84e07fee9', class: { 'fb-radio-group': true, 'has-error': this.isError }, disabled: this.disabled, "aria-describedby": hasHelper ? this.helperId : null, "aria-required": this.required ? 'true' : null }, index.h("legend", { key: 'c09d542ca39832ed8a8ef7fecfa9639d82c3a194', class: "fb-legend" }, this.label || 'Select an option'), index.h("div", { key: '2a5c1040d14f1961879f27ece76a09df7d9e7b5f', class: "options-list" }, options.map((opt) => {
...
const FbSwitch = class {
    ...
    render() {
        const hasHelper = !!this.helperText;
        return (index.h(index.Host, { key: 'b25865eb469e9324c70bb1d6f280bd6298557130' }, index.h("div", { key: 'd35b0d45c0a7cb174e9f3a33eb939d52a4a9e5e5', class: "fb-switch-wrapper" }, index.h("label", { key: 'fde740a50cd1fe17a1f8b81bbbfc42224143a03e', htmlFor: this.switchId, class: { 'fb-switch-label': true, 'disabled': this.disabled } }, index.h("input", { key: '4deddebe07abf8d1bfccea72cbf8b4649897d6b0', id: this.switchId, type: "checkbox", role: "switch", checked: this.checked, disabled: this.disabled, "aria-label": !this.label ? 'Toggle' : null, "aria-checked": this.checked ? 'true' : 'false', "aria-describedby": hasHelper ? this.helperId : null, class: "native-switch", onChange: (e) => {
                this.checked = e.target.checked;
                this.fbChange.emit(this.checked);
            } }), index.h("span", { key: 'cdfc04b6a40a5ba0d7120da589f3bae006371349', "aria-hidden": "true", class: { 'switch-track': true, 'on': this.checked } }, index.h("span", { key: 'd2d64266911f1a703ceba01ed48042efaf4e64f6', class: "switch-thumb" })), this.label && index.h("span", { key: '82e52960c127f952cd8fb6e837a4bb4a846ea6e2', class: "label-text" }, this.label)), hasHelper && (index.h("div", { key: '12d4531ccd4698fec7656e6f2a23944dbb3bb180', id: this.helperId, class: "fb-helper" }, this.helperText)))));
    }
};
...
const FbTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ae5d2e476d4f6cc4465eaaf5dd5274fa2d11fd49' }, index.h("span", { key: 'eea9a139d78cf6868f3fab702983f7f4ac8c54be', class: "fb-tooltip-wrapper", onMouseEnter: () => this.show(), onMouseLeave: () => this.hide(), onFocusin: () => this.show(), onFocusout: () => this.hide() }, index.h("span", { key: 'd1f206b0bad9a6349a7fbb35f97f9318429bccb3', "aria-describedby": this.visible ? this.tooltipId : null }, index.h("slot", { key: '6ec1783085a6913b0472f4c16dbb139f20523cba' })), this.visible && (index.h("span", { key: 'e417823a7b1f3ed1cb8d5c90d33d8c1aaceef528', id: this.tooltipId, role: "tooltip", class: `fb-tooltip fb-tooltip--${this.placement}` }, this.content)))));
    }
    get el() { return index.getElement(this); }
};
