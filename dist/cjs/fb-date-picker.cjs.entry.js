...
const FbDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0aa30e9503ff0f9ef34853362748720781a8b086' }, index.h("div", { key: 'de2e32427931b47832bcea15034a8604e61bfc01', class: "fb-dp-wrapper" }, this.label && (index.h("label", { key: '033c21182abeddd3238425927b0c20b88dd5c523', id: this.labelId, htmlFor: this.triggerId, class: "fb-label" }, this.label, this.required && index.h("span", { key: '965bab130c9e9b48e8bb54c36bbf4c8cd025ef68', class: "required-indicator", "aria-hidden": "true" }, " *"))), index.h("div", { key: '21bfe6277a4b4a8d385934de7d20c662a408d8a5', class: "fb-dp-container" }, index.h("button", { key: '80e3a06f247149de4ae6522bcb74a60c8ca16831', id: this.triggerId, type: "button", class: {
            ...
            } }, index.h("span", { key: '271810451dc2f69fee382be573dc6ec6bfdbba6e', class: "fb-dp-icon", "aria-hidden": "true" }, index.h("svg", { key: 'd94607d52f819ce0a13692d71826b3aed6473a25', width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", "stroke-width": "1.5" }, index.h("rect", { key: 'bf0478e4b4dec72804f14292ccf24460014ddf93', x: "2", y: "3", width: "12", height: "11", rx: "2" }), index.h("path", { key: 'ffe85a615efb7345846c24074d6a6513ebaeeae3', d: "M2 7h12" }), index.h("path", { key: '2d52c5fe82973701db54e1a1984f223fb97a83e9', d: "M5 2v2M11 2v2", "stroke-linecap": "round" }))), index.h("span", { key: '3f0b9a6a73171e377cf6a59680cf28f394c8cc7e', class: "fb-dp-text" }, this.displayText), this.hasValue && !this.isDisabled && (index.h("button", { key: '8cc5ed30ef7d2c31bc35b758ec3d08cd8b400ab3', type: "button", class: "fb-dp-clear", "aria-label": "Clear date", tabIndex: -1, onMouseDown: e => e.preventDefault(), onClick: this.clearValue }, index.h("svg", { key: '6e742be158b6edf3d7cb5eb2111cf18c0b4dc2a3', width: "14", height: "14", viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", "stroke-width": "1.5", "stroke-linecap": "round" }, index.h("path", { key: '6dab4aa673ba32da6231d6a40482ca8a7516dddb', d: "M3 3l10 10M13 3L3 13" }))))), this.open && (index.h("div", { key: '68e2e0c382e59e8e8daa6e8a5b6f9c72ee63283b', id: this.dialogId, role: "dialog", "aria-modal": "true", "aria-label": "Date picker calendar", class: { 'fb-cal-popup': true, 'fb-cal-popup--dual': showDual }, onKeyDown: e => {
                if (e.key === 'Escape') {
                    e.preventDefault();
                    this.closeCalendar();
                }
        ...
        ]) : (this.renderMonth(this.viewYear, this.viewMonth, true, true))))), hasHelper && (index.h("div", { key: '82ae06e1e99935e90d3781fa18bb4244e638fb5e', id: this.helperId, class: { 'fb-helper': true, 'fb-helper--error': this.isError }, role: this.isError ? 'alert' : null }, this.helperText)))));
    }
