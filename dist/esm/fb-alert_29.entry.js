...
const FbPopover = class {
    ...
    render() {
        return (h(Host, { key: 'ee255eb874bd89077eeee89309bae6ec9975ffa0' }, h("span", { key: '9dcf333186df6228f83d68df4b575ac93df73454', class: "fb-popover-anchor" }, h("button", { key: '8a4153d541d5ddf363275b06ab316f6ca0d46462', id: this.triggerId, type: "button", "aria-haspopup": "dialog", "aria-expanded": this._open ? 'true' : 'false', "aria-controls": this._open ? this.popoverId : null, class: "fb-popover-trigger", onClick: () => this.toggle() }, h("slot", { key: '3e43157c1f6fe618eea5dc72a942a84fa8f17aca', name: "trigger" }, "Open")), this._open && (h("div", { key: '06f04f6c1b9986e6593b07782217bc447ebf7f1a', id: this.popoverId, role: "dialog", "aria-modal": "false", "aria-label": this.heading || 'Popover', class: `fb-popover fb-popover--${this.placement}`, onKeyDown: this.handleKeyDown }, h("div", { key: '856ca288bb0c4e4ee98433ae39f4ed784fb3c355', class: "fb-popover__header" }, this.heading && h("span", { key: '55191fc4596f8ee159ed002a869b61ec7fc8f43c', class: "fb-popover__heading" }, this.heading), h("button", { key: 'c2a27daffbf373355667f73ea96a6b1ee9c99340', type: "button", class: "fb-popover__close", "aria-label": "Close popover", onClick: () => this.closePopover() }, h("svg", { key: '67eca66afe21bc78b1cf78860e3bbd300739a851', "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, h("path", { key: '951f26353111b0629dde50712b9b23934f286f6d', d: "M18 6L6 18M6 6l12 12" })))), h("div", { key: 'cb3540a3e543ad15bbad725759c0289a122787ef', class: "fb-popover__body" }, h("slot", { key: 'a58c06abd74e80cb5c041eb95f4b4938ebd1dae8' })))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "open": [{
