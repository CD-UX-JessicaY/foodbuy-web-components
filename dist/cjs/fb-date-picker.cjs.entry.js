...
const FbDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8567b65a74fde337e8f7febdc6e8f741cdda2341' }, index.h("div", { key: '094ba0f91e35d48b9276485dcd74ffd884d822da', class: "fb-dp-wrapper" }, this.label && (index.h("label", { key: '7f3de2bfa738feb09815fdfcb683b20c971d05cb', id: this.labelId, htmlFor: this.triggerId, class: "fb-label" }, this.label, this.required && index.h("span", { key: 'c8f120a786cd2217febf054f48c1f24707a0cc74', class: "required-indicator", "aria-hidden": "true" }, " *"))), index.h("div", { key: 'de71459983090f2ab028f69754f96196d89d3bb3', class: "fb-dp-container" }, index.h("button", { key: 'cf842f2acea966ae0b4c6c120e96cd9a6721c29e', id: this.triggerId, type: "button", class: {
                'fb-dp-trigger': true,
                'is-open': this.open,
            ...
            } }, index.h("span", { key: '5e05e016487c2e0de57ece1f477bfd9b8510eacd', class: "fb-dp-icon", "aria-hidden": "true" }, index.h("svg", { key: '0a2899153bb47bfb63acb4e0d070d3513e99e2a7', width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", "stroke-width": "1.5" }, index.h("rect", { key: 'aba24aa4ab10b79fbf170070e084283e3c09a18a', x: "2", y: "3", width: "12", height: "11", rx: "2" }), index.h("path", { key: '8a76b8cef9b25eb65698aa3bbbc87df16e83e218', d: "M2 7h12" }), index.h("path", { key: '83a5667eb56b3b1ddf7750a13f7f4f4a62424985', d: "M5 2v2M11 2v2", "stroke-linecap": "round" }))), index.h("span", { key: '027edaf729ea07e53b7339047466357bed3ef1b8', class: "fb-dp-text" }, this.displayText), this.hasValue && !this.isDisabled && (index.h("button", { key: '179c711091fb618dbbd5ed01c1cc5b1d5bf773d8', type: "button", class: "fb-dp-clear", "aria-label": "Clear date", tabIndex: -1, onMouseDown: e => e.preventDefault(), onClick: this.clearValue }, index.h("svg", { key: '58ab8dc8ed085b5588610c25f3808f14c48dfd0f', width: "14", height: "14", viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", "stroke-width": "1.5", "stroke-linecap": "round" }, index.h("path", { key: '44f1ebb639b445484a409141701b3ec5303f4497', d: "M3 3l10 10M13 3L3 13" }))))), this.open && (index.h("div", { key: '905436c551e269bcf4d7d115a6baf1e9a3c5bb5b', id: this.dialogId, role: "dialog", "aria-modal": "true", "aria-label": "Date picker calendar", class: { 'fb-cal-popup': true, 'fb-cal-popup--dual': showDual }, onKeyDown: e => {
                if (e.key === 'Escape') {
                    e.preventDefault();
                    this.closeCalendar();
                }
        ...
        ]) : (this.renderMonth(this.viewYear, this.viewMonth, true, true))))), hasHelper && (index.h("div", { key: '0f34f9765f79a087d0cbd7ecb37cf55b3723109a', id: this.helperId, class: { 'fb-helper': true, 'fb-helper--error': this.isError }, role: this.isError ? 'alert' : null }, this.helperText)))));
    }
