...
const FbDataTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e5a5c417f048d8932f9384d99b9356baa4199215' }, h("div", { key: '4bc0189d9c1297f8498eefebe6ee6e23f447d125', class: "fb-dt-wrapper" }, !this.hideToolbar && (h("div", { key: '473cfc956bc93cdd054e3de305b279161b41703a', class: "fb-dt-toolbar" }, h("input", { key: 'd3b16d5f1d77407267a9593a8fb770ba51a07e2a', class: "fb-dt-filter", type: "search", placeholder: "Filter by name or email\u2026", value: this.filter, "aria-label": "Filter rows", onInput: this.onFilterInput }), h("div", { key: '1b49e583159f7f6c2e4117e61898993772261a6f', class: "fb-dt-col-wrap" }, h("button", { key: '9484a721d5daed28eafa9aa1bd5d99ee3ee4f409', class: { 'fb-dt-col-btn': true, 'is-open': this.colMenuOpen }, "aria-haspopup": "true", "aria-expanded": this.colMenuOpen ? 'true' : 'false', onClick: e => { e.stopPropagation(); this.colMenuOpen = !this.colMenuOpen; this.rppMenuOpen = false; } }, h("svg", { key: '301055c50e4ff5fc6b8a13260c468512ac172ae5', "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 14 14", fill: "none" }, h("rect", { key: 'e910bc0d3e0d17d5a8174d56ab59816f1ddf18d5', x: "1", y: "1", width: "12", height: "2.5", rx: "1", fill: "currentColor", opacity: "0.5" }), h("rect", { key: '34606f8d0051da0e0c9bcc3a687c1d3276a0bac0', x: "1", y: "5.75", width: "12", height: "2.5", rx: "1", fill: "currentColor" }), h("rect", { key: 'b806dd7aed3b350f533ed2ecc071261e3da4cd21', x: "1", y: "10.5", width: "8", height: "2.5", rx: "1", fill: "currentColor", opacity: "0.5" })), "Columns"), this.colMenuOpen && (h("div", { key: '1c31ff6724c42c0dc92630f09cd82eb302853ba3', class: "fb-dt-col-menu", role: "menu", "aria-label": "Toggle columns" }, allCols.map(col => (h("label", { class: "fb-dt-col-item", key: col.key }, h("input", { type: "checkbox", checked: this.colVisibility[col.key] !== false, onChange: () => {
            ...
            } }), col.label)))))))), this.caption && h("h3", { key: 'ca7e1b1051bc852e1dc1e43cb188e0fa130e70f1', class: "fb-dt-caption" }, this.caption), h("div", { key: 'b1912981db40b8efd6747d2d87f684812f299aa1', class: "fb-dt-table-wrap" }, h("div", { key: '8036f5fb7534f1531da8200d553688e2b639777f', class: "fb-dt-scroll", tabIndex: 0, role: "region", "aria-label": this.caption ? `${this.caption} table` : 'Data table' }, h("table", { key: '99fee1c9de4aea86168d76f9fe4b7c5fe479b53e', class: "fb-dt-table", role: "grid", "aria-label": this.caption || 'Data table' }, h("thead", { key: '2598c67535933e509d040cc9bf51c37ace2c5414' }, h("tr", { key: 'ba788cf0043ad28e08aef4f6e151166fbdcf6968' }, showCbs && (h("th", { key: '449a20c7255fce8b3ef6879d3413189eaea2564b', scope: "col", class: "fb-dt-th fb-dt-th--cb" }, this.renderCheckbox(this._allPageSelected, this._somePageSelected, this.toggleAll, 'Select all rows'))), cols.map(col => (h("th", { key: col.key, scope: "col", class: {
                'fb-dt-th': true,
            ...
            } }, h("div", { class: { 'fb-dt-th-inner': true, 'fb-dt-th-inner--right': col.align === 'right' } }, col.align === 'right' && col.sortable && this.renderSortIcon(col.key), h("span", null, col.label), col.align !== 'right' && col.sortable && this.renderSortIcon(col.key))))), showAct && (h("th", { key: 'd9cc2e336102f08ccf2d5df8d92110e89fdc1815', scope: "col", class: "fb-dt-th fb-dt-th--actions", "aria-label": "Row actions" })))), h("tbody", { key: '34708ddf51af085cf11a49aef31be0497e250e4c' }, pagRows.length === 0
            ...
            }))))), showFooter && (h("div", { key: 'ede77296ec00dccff1e77c7490c47331e9816c4d', class: "fb-dt-footer" }, h("span", { key: '019a27e6e99a626c830f7a94397f82c13f417676', class: "fb-dt-row-count" }, !this.hideRowCount && `${this.selected.size} of ${this._filteredRows.length} row(s) selected`), h("div", { key: '3527befcdcb20af73b93e0cd28ee78a9e7b0a239', class: "fb-dt-footer-center" }, !this.hidePagination && this.renderPagination()), h("div", { key: '9b5ed61d1820b3170f2a3ebd657eeb0dab01611d', class: "fb-dt-footer-right" }, !this.hideRowsPerPage && (h("div", { key: 'd3cff6e75755fdd8b07935ddf25f375ea084d21b', class: "fb-dt-rpp" }, h("span", { key: '99bdf666842ce149c1a6199c7376fde77ae09b0a', class: "fb-dt-rpp-label" }, "Rows per page"), h("div", { key: 'ba436fd49ad1d7ee708c69b90b7b4a7c7572ff4f', class: "fb-dt-rpp-wrap" }, h("button", { key: '8814c7e7a1589580dd0701e23bf12a2b60d5c80f', class: { 'fb-dt-rpp-btn': true, 'is-open': this.rppMenuOpen }, "aria-haspopup": "listbox", "aria-expanded": this.rppMenuOpen ? 'true' : 'false', onClick: this.toggleRppMenu }, h("span", { key: 'e75d3db478d5fe334a3f240c0386ff9f973c6a5a' }, this.pageSize), h("svg", { key: '043b74513081a05f9f11e9f51e69be8aefd49ff6', width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", style: { transform: this.rppMenuOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' } }, h("path", { key: 'e7ccdfa8af072ea291c455fa7204cc58dac7d9ab', d: "M4 6l4 4 4-4", stroke: "currentColor", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }))), this.rppMenuOpen && (h("div", { key: '6e75c635f3f1e0dc51fcc6432ba8fd312c57f5eb', class: "fb-dt-rpp-menu", role: "listbox", "aria-label": "Rows per page" }, RPP_OPTIONS.map(opt => (h("div", { key: opt, class: { 'fb-dt-rpp-opt': true, 'fb-dt-rpp-opt--active': opt === this.pageSize }, role: "option", "aria-selected": opt === this.pageSize ? 'true' : 'false', onClick: () => this.setPageSize(opt) }, opt, opt === this.pageSize && (h("svg", { "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 14 14", fill: "none" }, h("path", { d: "M2 7l3.5 3.5L12 3", stroke: "currentColor", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" })))))))))))))), this.openActionRowId !== null && (h("div", { key: '634ff588bcdbd319a5d118e7e132d16cb710925e', class: "fb-dt-action-menu", role: "menu", "aria-label": "Row actions", style: { top: `${this.actionMenuPos.top}px`, left: `${this.actionMenuPos.left}px` } }, this._parsedRowActions.map((action, i) => {
            if (action.separator)
