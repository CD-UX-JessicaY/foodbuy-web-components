...
const FbResizableGroup = class {
    ...
    render() {
        ...
        index.h("svg", { width: "22", height: "6", viewBox: "0 0 22 6", fill: "none" }, [0, 4].map(y => [1, 5, 9, 13, 17, 21].map(x => index.h("circle", { key: `${x}-${y}`, cx: x, cy: y + 1, r: "1", fill: "currentColor" })))))))), index.h("div", { key: 'bf2dc345042720f3d822d7519f0a0a9ea77e6b5d', class: "fb-panel fb-panel--end", style: { [this.isH ? 'width' : 'height']: `${endSize}%` } }, index.h("slot", { key: '01694da2955043307f220663ea85ebc7839a780a', name: "end" })))));
    }
