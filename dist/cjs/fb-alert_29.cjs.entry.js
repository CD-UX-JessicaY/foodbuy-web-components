...
const FbAvatar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5dc6d20f9ef0cad0f27e5addbcc17ab6c5c38930' }, index.h("span", { key: 'bcb85fd9f2cd8b5b42bc5b2d3d3360cc7f5913ac', class: classes }, content, this.status !== 'none' && (index.h("span", { key: '018641dc7053f0a5f501b686875fef1be2a9ac34', class: `fb-avatar__status fb-avatar__status--${this.status}`, "aria-label": this.getStatusLabel(), role: "img" })))));
    }
};
...
const FbCheckbox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6198179c490277af847b4a9b09fe13d5ad101d2f' }, index.h("div", { key: '84dc2bd3299205b8e19fdd0cf8b280b8fcdeed9a', class: "fb-checkbox-wrapper" }, index.h("label", { key: 'c94a3214cc105bbe3cddce9d1a6c6df483474802', htmlFor: this.inputId, class: {
                'fb-checkbox-label': true,
                'disabled': this.isDisabled,
            } }, index.h("input", { key: '2512268e16515ab582d5d84319146be36fa81dda', id: this.inputId, type: "checkbox", checked: this.checked, disabled: this.isDisabled, required: this.required, value: this.value, "aria-required": this.required ? 'true' : null, "aria-invalid": this.isError ? 'true' : null, "aria-describedby": hasHelper ? this.helperId : null,
            ...
            } }), index.h("span", { key: 'a7602afdc021bf7feaea30bb86410e033c2aaa83', "aria-hidden": "true", class: {
                'checkbox-box': true,
                [`size-${this.size}`]: true,
            ...
            : this.checked
                ...
                : null), this.label && index.h("span", { key: '0dc47f5645e52fbf7243ec308dd9873f3215115c', class: "label-text" }, this.label)), hasHelper && (index.h("div", { key: 'ebdf2ab83bae1bb9c532d928b2579118b0093920', id: this.helperId, class: { 'fb-helper': true, 'fb-helper--error': this.isError }, role: this.isError ? 'alert' : null }, this.helperText)))));
    }
};
...
const fbPaginationCss = () => `:host{display:block}.fb-pagination{display:flex;align-items:center;gap:var(--spacing-4);font-family:var(--font-family-primary)}.page-btn{display:inline-flex;align-items:center;justify-content:center;min-width:36px;height:36px;padding:0 var(--spacing-4);border:1px solid var(--color-neutral-200);border-radius:var(--radius-sm);background:var(--color-neutral-white);color:var(--color-neutral-700);font-family:var(--font-family-primary);font-size:var(--font-size-14);cursor:pointer;transition:background-color 0.15s, border-color 0.15s}.page-btn:hover:not(:disabled){background-color:var(--color-neutral-50);border-color:var(--color-neutral-300)}.page-btn:focus-visible{outline:var(--focus-width) solid var(--focus-color);outline-offset:var(--focus-offset)}.page-btn:disabled{opacity:0.4;cursor:not-allowed}.page-btn.active{background-color:var(--color-primary-500);border-color:var(--color-primary-500);color:var(--color-neutral-white);font-weight:var(--font-weight-semibold)}.nav-btn{color:var(--color-neutral-500)}.ellipsis{display:inline-flex;align-items:center;justify-content:center;min-width:36px;height:36px;color:var(--color-neutral-400);font-size:var(--font-size-14);user-select:none}`;
...
const FbPagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f8ea5664986b6bc9cece03a2c60a1906212efb43' }, index.h("nav", { key: '2e01578113862d27ec57105388f2f1e73a212bd3', "aria-label": this.label, class: "fb-pagination" }, index.h("button", { key: 'aef57c6a375fa5b0a250acf6840191cdfa79aa89', type: "button", class: "page-btn nav-btn", "aria-label": "Go to previous page", disabled: isFirst, "aria-disabled": isFirst ? 'true' : null, onClick: () => this.go(this.currentPage - 1) }, index.h("svg", { key: '2a6a4f6b075953c687e337c9b306b7bc3d4590bd', "aria-hidden": "true", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: 'f4d26dafed31f16873158d6603234209d16c23f8', d: "M15 18l-6-6 6-6" }))), pages.map((page, i) => page === '...'
            ? index.h("span", { key: `ellipsis-${i}`, class: "ellipsis", "aria-hidden": "true" }, "\u2026")
            : (index.h("button", { key: page, type: "button", class: { 'page-btn': true, 'active': page === this.currentPage }, "aria-label": `Go to page ${page}`, "aria-current": page === this.currentPage ? 'page' : null, onClick: () => this.go(page) }, page))), index.h("button", { key: '121ef94bfe9a61dca98cfab66966fa5be8932650', type: "button", class: "page-btn nav-btn", "aria-label": "Go to next page", disabled: isLast, "aria-disabled": isLast ? 'true' : null, onClick: () => this.go(this.currentPage + 1) }, index.h("svg", { key: '204e0df48e11423af8a8e968f9c28345b7ead202', "aria-hidden": "true", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: '282c982e1526bcf9f34e45e414bd3ff31e5ebb15', d: "M9 18l6-6-6-6" }))))));
    }
};
...
const FbPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '61b1f2f135faa0d35e6920d8f1f9bea49fec9429' }, index.h("span", { key: '53db6764f86a0d6dce68492323623b6bf41bed01', class: "fb-popover-anchor" }, index.h("button", { key: 'b61b493df47219a6b553306520ad4726cf9f41d9', id: this.triggerId, type: "button", "aria-haspopup": "dialog", "aria-expanded": this._open ? 'true' : 'false', "aria-controls": this._open ? this.popoverId : null, class: "fb-popover-trigger", onClick: () => this.toggle() }, index.h("slot", { key: 'b5512b9fdfe722bed2e67c7d635ab083ecbdfae3', name: "trigger" }, "Open")), this._open && (index.h("div", { key: 'f5ecf98be46431042d45d4277bbb73dec4a61939', id: this.popoverId, role: "dialog", "aria-modal": "false", "aria-label": this.heading || 'Popover', class: `fb-popover fb-popover--${this.placement}`, onKeyDown: this.handleKeyDown }, index.h("div", { key: '32e58396d0760c40f89a682d3ca19092101958ef', class: "fb-popover__header" }, this.heading && index.h("span", { key: '2b89b37cefaa976594efb14e594e28f793e01ae4', class: "fb-popover__heading" }, this.heading), index.h("button", { key: 'd8726e06548fa2ce61d65005950541f7d9255d33', type: "button", class: "fb-popover__close", "aria-label": "Close popover", onClick: () => this.closePopover() }, index.h("svg", { key: 'c4f375d18cca38fc40eadedb97a2b7e48ad4bab8', "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: 'f91981a1572b79bc58e6b128fbd74395f68a66d7', d: "M18 6L6 18M6 6l12 12" })))), index.h("div", { key: '194123cda5ce18b4359c78aec47575ee70befce8', class: "fb-popover__body" }, index.h("slot", { key: '6b3bfd0f259ec2af15508acbef8bd729b827c371' })))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "open": [{
...
const FbSelect = class {
    ...
    render() {
        ...
        const activeId = this.open && this.focusedIndex >= 0
            ...
            : undefined;
        return (index.h(index.Host, { key: '313434f9907acad78a8ba0eec85e0f33b86cea10' }, index.h("div", { key: 'b57a0d2908cdc11680f174d49815c3c1a8a87446', class: "fb-select-wrapper", style: { fontFamily: 'var(--font-family-primary)' } }, this.label && (index.h("label", { key: '88115af578b92dd6b00a49f3734dd8c2cf6401fa', id: this.labelId, htmlFor: this.triggerId, class: "fb-label" }, this.label, this.required && index.h("span", { key: '14014ef8d1ed2ef1c4517739e9a6b4ca92b6f457', class: "required-indicator", "aria-hidden": "true" }, " *"))), index.h("div", { key: '5b0a6189f0dc209f7043299aaa0ba462f5b7b2f2', class: "fb-select-container", style: { position: 'relative' } }, index.h("button", { key: 'e2eb2a99e229573d3ea0b9c385e7d455b2f2266c', id: this.triggerId, type: "button", role: "combobox", "aria-haspopup": "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-controls": this.listboxId, "aria-labelledby": this.label ? `${this.labelId} ${this.triggerId}` : null, "aria-activedescendant": activeId, "aria-required": this.required ? 'true' : null, "aria-invalid": this.isError ? 'true' : null, "aria-describedby": hasHelper ? this.helperId : null, disabled: this.isDisabled, class: {
            ...
            }, onClick: () => this.open ? this.close() : this.open_(), onKeyDown: this.handleTriggerKeyDown }, index.h("span", { key: 'ebb029d9fa62dac6fed8d264ea0eff6c0aefa167', class: "trigger-text" }, this.selectedOption ? this.selectedOption.label : this.placeholder), index.h("span", { key: '4f8114ab3ba6af0ae36cd7313e0249ea19926b04', "aria-hidden": "true", class: { 'chevron': true, 'chevron--open': this.open } }, index.h("svg", { key: '6a50d3cc58926c414cbfb6273b060dc43561f83a', width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: '9dd3606c0088790e86f8a11f98a9df47d6c360f6', d: "M6 9l6 6 6-6" })))), this.open && (index.h("ul", { key: '519ce70d80fe8026b1896da3532216dce9e0ae56', id: this.listboxId, role: "listbox", "aria-label": this.label || 'Options', class: "fb-listbox" }, opts.map((opt) => {
            var _a;
        ...
        })))), hasHelper && (index.h("div", { key: 'a2b1c98973414b10f13e93bf07319d8a88b268c0', id: this.helperId, class: { 'fb-helper': true, 'fb-helper--error': this.isError }, role: this.isError ? 'alert' : null }, this.helperText)))));
    }
    get el() { return index.getElement(this); }
};
...
const FbSidebar = class {
    ...
    render() {
        const items = this.parsedItems;
        return (index.h(index.Host, { key: '306cff7696de1ebb67738bd4769984a0772dc87a' }, index.h("nav", { key: 'ed7d69bbd8e22e684b7f7c62c224a7a1984ae8d3', "aria-label": this.label, class: { 'fb-sidebar': true, 'fb-sidebar--collapsed': this.collapsed } }, index.h("ul", { key: 'd20cf25164f2f4589f844692e0a8c085fe5dd2a7', role: "list", class: "fb-sidebar__list" }, this.renderItems(items)), index.h("slot", { key: '823410195a9df4a93043f65d8032eeb2ee523d61', name: "footer" }))));
    }
};
...
const FbSkeleton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0db41cd256f6b6c2c161e539ff4ad3edf8288fe4' }, index.h("span", { key: '4c817ed1f6fdf6710cf09af84f41eeb7ba265b5a', "aria-hidden": "true", class: { 'fb-skeleton': true, [`variant-${this.variant}`]: true }, style: style })));
    }
};
...
const FbSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '82406bca363db2a0d15837aef618bd3da581ea1f' }, index.h("span", { key: '0b27cb8ffe3e22f95ea519d96fcf3c85812c87b5', role: "status", "aria-label": this.label, class: { 'fb-spinner': true, [`size-${this.size}`]: true } }, index.h("svg", { key: '2439875da5a014ee63fcde783deb310d08827c1d', "aria-hidden": "true", viewBox: "0 0 24 24", fill: "none", class: "spinner-svg" }, index.h("circle", { key: 'd6ea3f7040060e54e0744ab31daa06902fb71f20', class: "track", cx: "12", cy: "12", r: "10", "stroke-width": "2.5" }), index.h("path", { key: '65c1d1d882cc9c76ee5c8bc157201ff3d5f044d8', class: "arc", d: "M12 2a10 10 0 0 1 10 10", "stroke-width": "2.5", "stroke-linecap": "round" })), index.h("span", { key: '33758a9667b49bfb4da326a18694fa227d89a984', class: "visually-hidden" }, this.label))));
    }
};
...
const FbSwitch = class {
    ...
    render() {
        const hasHelper = !!this.helperText;
        return (index.h(index.Host, { key: '95d52933821b2f3676b10c7a6507473edfaee0f4' }, index.h("div", { key: '772a90ee095cc31243f9f46790636051f39b6266', class: "fb-switch-wrapper" }, index.h("label", { key: 'd47b563e16d676095f3e83d0f1a9889efc8cd5ad', htmlFor: this.switchId, class: { 'fb-switch-label': true, 'disabled': this.disabled } }, index.h("input", { key: '8793bcf1d810c8b2f4413e0927bf27260f1a1f2f', id: this.switchId, type: "checkbox", role: "switch", checked: this.checked, disabled: this.disabled, "aria-checked": this.checked ? 'true' : 'false', "aria-describedby": hasHelper ? this.helperId : null, class: "native-switch", onChange: (e) => {
                this.checked = e.target.checked;
                this.fbChange.emit(this.checked);
            } }), index.h("span", { key: '25721984c1deb47ccf6e8fb92b9a6918a5bd59f3', "aria-hidden": "true", class: { 'switch-track': true, 'on': this.checked } }, index.h("span", { key: '3fa2beb75ab2acb68a0ca92bbd35ddbd431ae168', class: "switch-thumb" })), this.label && index.h("span", { key: '81fa0765953c018ac02b86ae0c5bc5fd38d07f50', class: "label-text" }, this.label)), hasHelper && (index.h("div", { key: '43c0e60336f1083511815fbd88a1c711ccc5f37f', id: this.helperId, class: "fb-helper" }, this.helperText)))));
    }
};
...
const FbTabs = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6e5dfc617b109630dd86b81e559113bef8eeceda', ref: (el) => this.el = el }, index.h("div", { key: 'e1de632f1442b9b90f58d931d4ebd247d0b2be4b', role: "tablist", "aria-label": this.label, class: {
                'fb-tablist': true,
                [`variant-${this.variant}`]: true,
...
const FbTextarea = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '630b8868b728ea7c4f8a4f35fa011dfaa6a7eda2' }, index.h("div", { key: '74753e90d501a52cdc5ee9a4e88da136a82e5dde', class: "fb-textarea-wrapper" }, this.label && (index.h("label", { key: '1dd225293354e08fd408c35c441a649e24d5aa73', htmlFor: this.textareaId, class: "fb-label" }, this.label, this.required && index.h("span", { key: 'c2ae106aee20a65a91c8b33db38d269a598f900f', class: "required-indicator", "aria-hidden": "true" }, " *"))), index.h("textarea", { key: '59bf5e4092a549cca31b17280b31702bb245d4c3', id: this.textareaId, rows: this.rows, placeholder: this.placeholder, disabled: this.isDisabled, readOnly: this.isReadOnly, required: this.required, maxLength: this.maxLength, "aria-required": this.required ? 'true' : null, "aria-invalid": this.isError ? 'true' : null, "aria-describedby": describedBy, class: {
                'fb-textarea': true,
                [`size-${this.size}`]: true,
                'state-error': this.isError,
                'state-disabled': this.isDisabled,
...
const FbTimeline = class {
    ...
    render() {
        const items = this.parsedItems;
        return (index.h(index.Host, { key: '1eed34c9e14569dfa362dae454327c007ad06422' }, index.h("ol", { key: 'e5c78e16827cdfcd96e500c5099b18498ff76daa', "aria-label": this.label, class: `fb-timeline fb-timeline--${this.orientation}` }, items.map((item, i) => {
            var _a, _b, _c;
...
const FbToggle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2cd30d0450f8c13eddfc424d92858c0c7942a5ba' }, index.h("button", { key: '5fa3d3ac05f735f4de8530591e9517922a80e41a', type: "button", class: {
                'fb-toggle': true,
                [`variant-${this.variant}`]: true,
                [`size-${this.size}`]: true,
                'pressed': this.pressed,
                'disabled': this.disabled,
            }, "aria-pressed": String(this.pressed), "aria-label": this.label || null, disabled: this.disabled, onClick: this.handleClick }, index.h("slot", { key: '377ec0b21e2d7f466069e3a79ed3a23a61cdf11c' }))));
    }
};
...
const FbToggleGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '10bdf9353c8e0f0dadf8b4e58d52df2a73bb5207' }, index.h("div", { key: '43ef648fb0a35584fc820e7bd72c312a8574c911', role: "group", "aria-label": this.label, "aria-disabled": this.disabled ? 'true' : null, class: {
...
const FbTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0702c9e86ef0bdc1202424a115b8e758eedb52db' }, index.h("span", { key: '0cf5909c7c2d41bde9befc76d24833e7b4175d2f', class: "fb-tooltip-wrapper", onMouseEnter: () => this.show(), onMouseLeave: () => this.hide(), onFocusin: () => this.show(), onFocusout: () => this.hide() }, index.h("span", { key: 'bebd92b79909cb5e55ea1ed0f10eea193a9338bb', "aria-describedby": this.visible ? this.tooltipId : null }, index.h("slot", { key: 'b895d9f582f2ecd70a5fb11f06a9b564ba3b9fda' })), this.visible && (index.h("span", { key: 'b3ffe4bad494064e1d86d22dc1300c04a9f8d59c', id: this.tooltipId, role: "tooltip", class: `fb-tooltip fb-tooltip--${this.placement}` }, this.content)))));
    }
    get el() { return index.getElement(this); }
};
