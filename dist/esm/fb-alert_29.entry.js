...
import { a as renderHelperText, r as renderFieldLabel } from './field-helpers-BZiDZ0Yy.js';
...
const FbTabs = class {
    ...
    render() {
        ...
        return (h(Host, { key: '926c16d554589ecaaf090fb4854b5611408151fd', ref: (el) => this.el = el }, h("div", { key: 'f50215b17fa23d471f25d21d91bc0934e58a8920', role: "tablist", "aria-label": this.label, class: {
                'fb-tablist': true,
                [`variant-${this.variant}`]: true,
...
const FbTimeline = class {
    ...
    render() {
        const items = this.parsedItems;
        return (h(Host, { key: '0d9f0e9173042f197772277da647ff25f1f9b6e8' }, h("ol", { key: 'd3a7bc356c2966a2482e8baee87827bdc7f0f48e', "aria-label": this.label, class: `fb-timeline fb-timeline--${this.orientation}` }, items.map((item, i) => {
            var _a, _b, _c;
...
const FbTooltip = class {
    ...
    render() {
        return (h(Host, { key: '8569c809ebe14ce0696b148333305f12b24aaf3c' }, h("span", { key: 'fa84e90a283af458fdd6643823e7176219e318bb', class: "fb-tooltip-wrapper", onMouseEnter: () => this.show(), onMouseLeave: () => this.hide(), onFocusin: () => this.show(), onFocusout: () => this.hide() }, h("span", { key: 'ebeb071f32282a15c297eb82d79f4d9bf1e3b350', "aria-describedby": this.visible ? this.tooltipId : null }, h("slot", { key: '42c3cba8eb682a20c0c658cf90102b01f4b29c20' })), this.visible && (h("span", { key: 'a543cb7843d4c692f890f1ec9a899d70cfc7c80c', id: this.tooltipId, role: "tooltip", class: `fb-tooltip fb-tooltip--${this.placement}` }, this.content)))));
    }
    get el() { return getElement(this); }
};
