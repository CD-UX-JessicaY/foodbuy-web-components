...
const FbDataTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '43476da5e4a6eca6afacf773dfc0de14c81c602b' }, index.h("div", { key: '89c869a83298eaa77a271b9241a475ad399a0219', class: "fb-dt-wrapper" }, !this.hideToolbar && (index.h("div", { key: '9c5a5b304894badf5fe884ceea1f9174c1e8cfc6', class: "fb-dt-toolbar" }, index.h("input", { key: '44e51f625abe33af90d0f871ea651e0961e941b4', class: "fb-dt-filter", type: "search", placeholder: "Filter by name or email\u2026", value: this.filter, "aria-label": "Filter rows", onInput: this.onFilterInput }), index.h("div", { key: '3459c0f3dada8898af5f4f1101748a548ea7227e', class: "fb-dt-col-wrap" }, index.h("button", { key: '0c0c2ebd78432b56b8addd806cf72bb04c40fe8f', class: { 'fb-dt-col-btn': true, 'is-open': this.colMenuOpen }, "aria-haspopup": "true", "aria-expanded": this.colMenuOpen ? 'true' : 'false', onClick: e => { e.stopPropagation(); this.colMenuOpen = !this.colMenuOpen; this.rppMenuOpen = false; } }, index.h("svg", { key: '1fd6ce1dec961e40476b5ebf2af3883751d98d69', "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 14 14", fill: "none" }, index.h("rect", { key: '8c1210539d7e45ecaa847a666afc434134ac19b7', x: "1", y: "1", width: "12", height: "2.5", rx: "1", fill: "currentColor", opacity: "0.5" }), index.h("rect", { key: '4e85bcc97f0d9343fbe1e8b0606f12ed5c59742f', x: "1", y: "5.75", width: "12", height: "2.5", rx: "1", fill: "currentColor" }), index.h("rect", { key: '0e86b3afdb583032b1de8c99abd87b5b62ed939d', x: "1", y: "10.5", width: "8", height: "2.5", rx: "1", fill: "currentColor", opacity: "0.5" })), "Columns"), this.colMenuOpen && (index.h("div", { key: '43512f2d43945097269e3f5c47a65d1531b70ec0', class: "fb-dt-col-menu", role: "menu", "aria-label": "Toggle columns" }, allCols.map(col => (index.h("label", { class: "fb-dt-col-item", key: col.key }, index.h("input", { type: "checkbox", checked: this.colVisibility[col.key] !== false, onChange: () => {
                this.colVisibility = Object.assign(Object.assign({}, this.colVisibility), { [col.key]: !(this.colVisibility[col.key] !== false) });
            } }), col.label)))))))), this.caption && index.h("h3", { key: '451786ca135522bd83cc96b98334b368b6641948', class: "fb-dt-caption" }, this.caption), index.h("div", { key: 'e68100bfcd5db1ba3d60a27c11c544b45d056ed1', class: "fb-dt-table-wrap" }, index.h("div", { key: 'dfb327321b9b77861fc62101afc54bb001dbbf2d', class: "fb-dt-scroll", tabIndex: 0, role: "region", "aria-label": this.caption ? `${this.caption} table` : 'Data table' }, index.h("table", { key: '9ad69a312af38125ae7074c4b8a30fbf6c55f22e', class: "fb-dt-table", role: "grid", "aria-label": this.caption || 'Data table' }, index.h("thead", { key: '0f55898158f7b276ffae93e696552076201933a1' }, index.h("tr", { key: 'fac8da48217f458769697583c97e8502cbf05eb3' }, showCbs && (index.h("th", { key: '6e65bc2decc96177919356e690eb6f0db40bcdd0', scope: "col", class: "fb-dt-th fb-dt-th--cb" }, this.renderCheckbox(this._allPageSelected, this._somePageSelected, this.toggleAll, 'Select all rows'))), cols.map(col => (index.h("th", { key: col.key, scope: "col", class: {
                'fb-dt-th': true,
            ...
            } }, index.h("div", { class: { 'fb-dt-th-inner': true, 'fb-dt-th-inner--right': col.align === 'right' } }, col.align === 'right' && col.sortable && this.renderSortIcon(col.key), index.h("span", null, col.label), col.align !== 'right' && col.sortable && this.renderSortIcon(col.key))))), showAct && (index.h("th", { key: '6d20595d329c943076e55860c1811c1cb01227ae', scope: "col", class: "fb-dt-th fb-dt-th--actions", "aria-label": "Row actions" })))), index.h("tbody", { key: 'fd11e7c8d8971ecd3341cfe3de638f5b60de21a1' }, pagRows.length === 0
            ...
            }))))), showFooter && (index.h("div", { key: '36084e794d9252c3fc58ae7f2fee02ae1febc2c9', class: "fb-dt-footer" }, index.h("span", { key: 'bcfb2f920c391aa369e8140812ea4edc9cd5160d', class: "fb-dt-row-count" }, !this.hideRowCount && `${this.selected.size} of ${this._filteredRows.length} row(s) selected`), index.h("div", { key: '9ff54ae095f6aa2c916752eb205e95975e89b864', class: "fb-dt-footer-center" }, !this.hidePagination && this.renderPagination()), index.h("div", { key: '52d4637edf3fadc993cda0f1756cb5d8027f5d90', class: "fb-dt-footer-right" }, !this.hideRowsPerPage && (index.h("div", { key: 'ceb803a6c5ccc39463ec6e30a53fcd5fae992fb3', class: "fb-dt-rpp" }, index.h("span", { key: '90e389807d8cdd4773fcc47386e22b620cc4a8c3', class: "fb-dt-rpp-label" }, "Rows per page"), index.h("div", { key: '42e26402e224b57605a170e067d49037836bc566', class: "fb-dt-rpp-wrap" }, index.h("button", { key: '8be1607d39cfcef220b2c211ed2f6a423684e34c', class: { 'fb-dt-rpp-btn': true, 'is-open': this.rppMenuOpen }, "aria-haspopup": "listbox", "aria-expanded": this.rppMenuOpen ? 'true' : 'false', onClick: this.toggleRppMenu }, index.h("span", { key: 'f054f4918a1968996261c210d98bf899363d7d65' }, this.pageSize), index.h("svg", { key: '0a0eb82a9c884cbe3687b50ffb1592e29b032963', width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", style: { transform: this.rppMenuOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' } }, index.h("path", { key: '8bcee51bea0b05de48369e974d73688bdde7716e', d: "M4 6l4 4 4-4", stroke: "currentColor", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }))), this.rppMenuOpen && (index.h("div", { key: '77f39bdb23573c6be05e6c55695b7ddb4ed69996', class: "fb-dt-rpp-menu", role: "listbox", "aria-label": "Rows per page" }, RPP_OPTIONS.map(opt => (index.h("div", { key: opt, class: { 'fb-dt-rpp-opt': true, 'fb-dt-rpp-opt--active': opt === this.pageSize }, role: "option", "aria-selected": opt === this.pageSize ? 'true' : 'false', onClick: () => this.setPageSize(opt) }, opt, opt === this.pageSize && (index.h("svg", { "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 14 14", fill: "none" }, index.h("path", { d: "M2 7l3.5 3.5L12 3", stroke: "currentColor", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" })))))))))))))), this.openActionRowId !== null && (index.h("div", { key: '258cd574ee1d149697e6f44ec978608795036ee1', class: "fb-dt-action-menu", role: "menu", "aria-label": "Row actions", style: { top: `${this.actionMenuPos.top}px`, left: `${this.actionMenuPos.left}px` } }, this._parsedRowActions.map((action, i) => {
            if (action.separator)
