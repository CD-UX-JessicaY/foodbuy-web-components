...
const FbPagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '01724bfbca19d482c5066aeb6d5922fc48d78c33' }, index.h("nav", { key: '94f684d61dbd2131fc0949ccee41b2d34745612b', "aria-label": this.label, class: "fb-pagination" }, index.h("button", { key: 'd12c702f56a293bcdc1d9dc55584b40fc5cefc42', type: "button", class: "page-btn nav-btn", "aria-label": "Go to previous page", disabled: isFirst, "aria-disabled": isFirst ? 'true' : null, onClick: () => this.go(this.currentPage - 1) }, index.h("svg", { key: 'f8ff6b772362c52f2cb1fb08b9859f7817e93460', "aria-hidden": "true", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: 'e4c65a53d3bf73b6d552116e712523322049c785', d: "M15 18l-6-6 6-6" }))), pages.map((page, i) => page === '...'
            ? index.h("span", { key: `ellipsis-${i}`, class: "ellipsis", "aria-hidden": "true" }, "\u2026")
            : (index.h("button", { key: page, type: "button", class: { 'page-btn': true, 'active': page === this.currentPage }, "aria-label": `Go to page ${page}`, "aria-current": page === this.currentPage ? 'page' : null, onClick: () => this.go(page) }, page))), index.h("button", { key: '4286efc6753d06a773267265bab8cd0d20204bec', type: "button", class: "page-btn nav-btn", "aria-label": "Go to next page", disabled: isLast, "aria-disabled": isLast ? 'true' : null, onClick: () => this.go(this.currentPage + 1) }, index.h("svg", { key: 'cbf63c02e6a4b996e6face9d3d828e7532b323e9', "aria-hidden": "true", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: '9b1e717c26b6157497a4667d3a9f18d0908159c8', d: "M9 18l6-6-6-6" }))))));
    }
};
...
const FbPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '76a1f904d3aa6e9b71e4bc5f90eb4d669be685a1' }, index.h("span", { key: '3f43953afba723e17b6de6f4a8cd275c485f26af', class: "fb-popover-anchor" }, index.h("button", { key: '147dc6f1630884e9e8bb21928dde40f5fba19ec9', id: this.triggerId, type: "button", "aria-haspopup": "dialog", "aria-expanded": this._open ? 'true' : 'false', "aria-controls": this._open ? this.popoverId : null, class: "fb-popover-trigger", onClick: () => this.toggle() }, index.h("slot", { key: 'c4d0875d8b601e1e7ff7560945b1fa4cbe8a8bf4', name: "trigger" }, "Open")), this._open && (index.h("div", { key: '974044572aa8afa1cf07484df624992b82eda5b6', id: this.popoverId, role: "dialog", "aria-modal": "false", "aria-label": this.heading || 'Popover', class: `fb-popover fb-popover--${this.placement}`, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'a518dca2b14d242b7a6c015879bcb63ea6b22118', class: "fb-popover__header" }, this.heading && index.h("span", { key: '764f14ff1a6d3d9aff86b9585018c0fd3724961a', class: "fb-popover__heading" }, this.heading), index.h("button", { key: '1c18af977221899b21a2f6028bbd7218e40f89da', type: "button", class: "fb-popover__close", "aria-label": "Close popover", onClick: () => this.closePopover() }, index.h("svg", { key: '49ca8f105c2680db48c85b132e50483ab02baf48', "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: '9626df4b1190ec24cf6b9c7b4f82c1df8a8f0454', d: "M18 6L6 18M6 6l12 12" })))), index.h("div", { key: '0e8d0d32cd3d832a50693c9c774b264e5f68ec07', class: "fb-popover__body" }, index.h("slot", { key: 'cc99094b383ecf882109b49449c981f095855ee4' })))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "open": [{
...
const FbSwitch = class {
    ...
    render() {
        const hasHelper = !!this.helperText;
        return (index.h(index.Host, { key: '7f20cf5e0eab30491eb3b76be6a1f70f7770ba8b' }, index.h("div", { key: 'fb692aced4ba86f6452fda63a37a94ade07fac4a', class: "fb-switch-wrapper" }, index.h("label", { key: '5e98d84412ac8237140ec68ce6a6086bcca18443', htmlFor: this.switchId, class: { 'fb-switch-label': true, 'disabled': this.disabled } }, index.h("input", { key: '9d03d9ed494b735ba5b6c81ece1dda09130bf4d2', id: this.switchId, type: "checkbox", role: "switch", checked: this.checked, disabled: this.disabled, "aria-checked": this.checked ? 'true' : 'false', "aria-describedby": hasHelper ? this.helperId : null, class: "native-switch", onChange: (e) => {
                this.checked = e.target.checked;
                this.fbChange.emit(this.checked);
            } }), index.h("span", { key: 'd9f3001a9a34fa2cbd168cf0db23144dae771c61', "aria-hidden": "true", class: { 'switch-track': true, 'on': this.checked } }, index.h("span", { key: 'd66e64a04438381782fd1e77bfbe49e17a507a86', class: "switch-thumb" })), this.label && index.h("span", { key: 'b84109c03fae55ac9e23823720008e5bec007fea', class: "label-text" }, this.label)), hasHelper && (index.h("div", { key: '544bccc9cd4b949e25c506695dbe443b2fbdfd41', id: this.helperId, class: "fb-helper" }, this.helperText)))));
    }
};
...
const FbTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5c6e4c64e2eb61e0aec496f44ce933c3607dc6a5' }, index.h("span", { key: 'c5e348f4d520b955e56d39d5e399ea59bed9fc66', class: "fb-tooltip-wrapper", onMouseEnter: () => this.show(), onMouseLeave: () => this.hide(), onFocusin: () => this.show(), onFocusout: () => this.hide() }, index.h("span", { key: 'a3939c91652228608ac2490865b48d38b38b426b', "aria-describedby": this.visible ? this.tooltipId : null }, index.h("slot", { key: 'dd8e8bec3b3b696305c0e59da4d3a6ab693611df' })), this.visible && (index.h("span", { key: '86bbcfbf987d3d1c844c7fb325e80763b5a6ca85', id: this.tooltipId, role: "tooltip", class: `fb-tooltip fb-tooltip--${this.placement}` }, this.content)))));
    }
    get el() { return index.getElement(this); }
};
