...
const FbDataTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e5a5c417f048d8932f9384d99b9356baa4199215' }, index.h("div", { key: '4bc0189d9c1297f8498eefebe6ee6e23f447d125', class: "fb-dt-wrapper" }, !this.hideToolbar && (index.h("div", { key: '473cfc956bc93cdd054e3de305b279161b41703a', class: "fb-dt-toolbar" }, index.h("input", { key: 'd3b16d5f1d77407267a9593a8fb770ba51a07e2a', class: "fb-dt-filter", type: "search", placeholder: "Filter by name or email\u2026", value: this.filter, "aria-label": "Filter rows", onInput: this.onFilterInput }), index.h("div", { key: '1b49e583159f7f6c2e4117e61898993772261a6f', class: "fb-dt-col-wrap" }, index.h("button", { key: '9484a721d5daed28eafa9aa1bd5d99ee3ee4f409', class: { 'fb-dt-col-btn': true, 'is-open': this.colMenuOpen }, "aria-haspopup": "true", "aria-expanded": this.colMenuOpen ? 'true' : 'false', onClick: e => { e.stopPropagation(); this.colMenuOpen = !this.colMenuOpen; this.rppMenuOpen = false; } }, index.h("svg", { key: '301055c50e4ff5fc6b8a13260c468512ac172ae5', "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 14 14", fill: "none" }, index.h("rect", { key: 'e910bc0d3e0d17d5a8174d56ab59816f1ddf18d5', x: "1", y: "1", width: "12", height: "2.5", rx: "1", fill: "currentColor", opacity: "0.5" }), index.h("rect", { key: '34606f8d0051da0e0c9bcc3a687c1d3276a0bac0', x: "1", y: "5.75", width: "12", height: "2.5", rx: "1", fill: "currentColor" }), index.h("rect", { key: 'b806dd7aed3b350f533ed2ecc071261e3da4cd21', x: "1", y: "10.5", width: "8", height: "2.5", rx: "1", fill: "currentColor", opacity: "0.5" })), "Columns"), this.colMenuOpen && (index.h("div", { key: '1c31ff6724c42c0dc92630f09cd82eb302853ba3', class: "fb-dt-col-menu", role: "menu", "aria-label": "Toggle columns" }, allCols.map(col => (index.h("label", { class: "fb-dt-col-item", key: col.key }, index.h("input", { type: "checkbox", checked: this.colVisibility[col.key] !== false, onChange: () => {
            ...
            } }), col.label)))))))), this.caption && index.h("h3", { key: 'ca7e1b1051bc852e1dc1e43cb188e0fa130e70f1', class: "fb-dt-caption" }, this.caption), index.h("div", { key: 'b1912981db40b8efd6747d2d87f684812f299aa1', class: "fb-dt-table-wrap" }, index.h("div", { key: '348e1f0b28e44baac897f78fccbdc5cb7dca7c3d', class: "fb-dt-scroll" }, index.h("table", { key: 'ba2b06079f8baefa1dca4b6e145f2ef95f140c3f', class: "fb-dt-table", role: "grid", "aria-label": this.caption || 'Data table' }, index.h("thead", { key: 'e18fc9db18ea8bf9f39cffc8b01a7c08f2c58b46' }, index.h("tr", { key: '6b6ec7db7e8a5439a3c57812e5acf44ff2ca4e78' }, showCbs && (index.h("th", { key: '22806719add273ac33c0ecb73b41a9a5cd2a4202', scope: "col", class: "fb-dt-th fb-dt-th--cb" }, this.renderCheckbox(this._allPageSelected, this._somePageSelected, this.toggleAll, 'Select all rows'))), cols.map(col => (index.h("th", { key: col.key, scope: "col", class: {
                'fb-dt-th': true,
            ...
            } }, index.h("div", { class: { 'fb-dt-th-inner': true, 'fb-dt-th-inner--right': col.align === 'right' } }, col.align === 'right' && col.sortable && this.renderSortIcon(col.key), index.h("span", null, col.label), col.align !== 'right' && col.sortable && this.renderSortIcon(col.key))))), showAct && (index.h("th", { key: '9fba4707ca1ce70acde7b12d4fca5acfbcba85e1', scope: "col", class: "fb-dt-th fb-dt-th--actions", "aria-label": "Row actions" })))), index.h("tbody", { key: '920505f42ff98638d49d55ebf7f50b4e4b7e59bf' }, pagRows.length === 0
            ...
            }))))), showFooter && (index.h("div", { key: 'a3285e5c785b857378cf135b4e3a5e474cc3c195', class: "fb-dt-footer" }, index.h("span", { key: '20687c697a9962e3d804e4178a6bc251f8842a39', class: "fb-dt-row-count" }, !this.hideRowCount && `${this.selected.size} of ${this._filteredRows.length} row(s) selected`), index.h("div", { key: '0610c21ed44e2d37cad46b587898404e5f3010aa', class: "fb-dt-footer-center" }, !this.hidePagination && this.renderPagination()), index.h("div", { key: 'f36c5300a8ae1858f10278a82112960fc8c3a1a3', class: "fb-dt-footer-right" }, !this.hideRowsPerPage && (index.h("div", { key: '1de0c711feebb4b8512a107491b997db3570df18', class: "fb-dt-rpp" }, index.h("span", { key: '8ea4f7e55dafa3a7800a427e1fe9a5f4c19b1a54', class: "fb-dt-rpp-label" }, "Rows per page"), index.h("div", { key: '4cf7ac3ae5fa796099269a45655300483fae71e8', class: "fb-dt-rpp-wrap" }, index.h("button", { key: '82f78f1dce63e5a6850267af99951558741c4bbb', class: { 'fb-dt-rpp-btn': true, 'is-open': this.rppMenuOpen }, "aria-haspopup": "listbox", "aria-expanded": this.rppMenuOpen ? 'true' : 'false', onClick: this.toggleRppMenu }, index.h("span", { key: 'a4231a2348cae61139fd1843a5389db23017d86c' }, this.pageSize), index.h("svg", { key: '2683039aced0287010ee8d2a89a590eaed9b0444', width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", style: { transform: this.rppMenuOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' } }, index.h("path", { key: '58f106ba7ac446c5b7dd0365bbb506516226266a', d: "M4 6l4 4 4-4", stroke: "currentColor", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }))), this.rppMenuOpen && (index.h("div", { key: '07b2fde2c6bf6d4ad91cf4c1f8f6f32ea2bc3446', class: "fb-dt-rpp-menu", role: "listbox", "aria-label": "Rows per page" }, RPP_OPTIONS.map(opt => (index.h("div", { key: opt, class: { 'fb-dt-rpp-opt': true, 'fb-dt-rpp-opt--active': opt === this.pageSize }, role: "option", "aria-selected": opt === this.pageSize ? 'true' : 'false', onClick: () => this.setPageSize(opt) }, opt, opt === this.pageSize && (index.h("svg", { "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 14 14", fill: "none" }, index.h("path", { d: "M2 7l3.5 3.5L12 3", stroke: "currentColor", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" })))))))))))))), this.openActionRowId !== null && (index.h("div", { key: '1384c4e119385a2393bb3fe4666c7fc88531de0c', class: "fb-dt-action-menu", role: "menu", "aria-label": "Row actions", style: { top: `${this.actionMenuPos.top}px`, left: `${this.actionMenuPos.left}px` } }, this._parsedRowActions.map((action, i) => {
            if (action.separator)
