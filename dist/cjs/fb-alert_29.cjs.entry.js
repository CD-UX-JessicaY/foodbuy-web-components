...
const FbPagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '850bf3c43b828b85d974b21e94aa207902649c31' }, index.h("nav", { key: '23c421b412ed50f9783a971d59d3e5d8dfb0151a', "aria-label": this.label, class: "fb-pagination" }, index.h("button", { key: 'fa857a5f0e9e9012937704b5b2a4cb7e1db7219d', type: "button", class: "page-btn nav-btn", "aria-label": "Go to previous page", disabled: isFirst, "aria-disabled": isFirst ? 'true' : null, onClick: () => this.go(this.currentPage - 1) }, index.h("svg", { key: '3d21a5a0d9161367c8606690ca45ee95cc0262f9', "aria-hidden": "true", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: 'fd65efcf6ea91194b624cbda2a366ed1f987b5df', d: "M15 18l-6-6 6-6" }))), pages.map((page, i) => page === '...'
            ? index.h("span", { key: `ellipsis-${i}`, class: "ellipsis", "aria-hidden": "true" }, "\u2026")
            : (index.h("button", { key: page, type: "button", class: { 'page-btn': true, 'active': page === this.currentPage }, "aria-label": `Go to page ${page}`, "aria-current": page === this.currentPage ? 'page' : null, onClick: () => this.go(page) }, page))), index.h("button", { key: 'b0edb436a5c370d5f6a5f853e902880d9008a50a', type: "button", class: "page-btn nav-btn", "aria-label": "Go to next page", disabled: isLast, "aria-disabled": isLast ? 'true' : null, onClick: () => this.go(this.currentPage + 1) }, index.h("svg", { key: 'c8b4ffa578376fe564d9f22f84a76e281420c680', "aria-hidden": "true", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: 'a22b423b8e6eeb81054d51a01b075c372740098d', d: "M9 18l6-6-6-6" }))))));
    }
};
...
const FbPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ee255eb874bd89077eeee89309bae6ec9975ffa0' }, index.h("span", { key: '9dcf333186df6228f83d68df4b575ac93df73454', class: "fb-popover-anchor" }, index.h("button", { key: '8a4153d541d5ddf363275b06ab316f6ca0d46462', id: this.triggerId, type: "button", "aria-haspopup": "dialog", "aria-expanded": this._open ? 'true' : 'false', "aria-controls": this._open ? this.popoverId : null, class: "fb-popover-trigger", onClick: () => this.toggle() }, index.h("slot", { key: '3e43157c1f6fe618eea5dc72a942a84fa8f17aca', name: "trigger" }, "Open")), this._open && (index.h("div", { key: '06f04f6c1b9986e6593b07782217bc447ebf7f1a', id: this.popoverId, role: "dialog", "aria-modal": "false", "aria-label": this.heading || 'Popover', class: `fb-popover fb-popover--${this.placement}`, onKeyDown: this.handleKeyDown }, index.h("div", { key: '856ca288bb0c4e4ee98433ae39f4ed784fb3c355', class: "fb-popover__header" }, this.heading && index.h("span", { key: '55191fc4596f8ee159ed002a869b61ec7fc8f43c', class: "fb-popover__heading" }, this.heading), index.h("button", { key: 'c2a27daffbf373355667f73ea96a6b1ee9c99340', type: "button", class: "fb-popover__close", "aria-label": "Close popover", onClick: () => this.closePopover() }, index.h("svg", { key: '67eca66afe21bc78b1cf78860e3bbd300739a851', "aria-hidden": "true", width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: '951f26353111b0629dde50712b9b23934f286f6d', d: "M18 6L6 18M6 6l12 12" })))), index.h("div", { key: 'cb3540a3e543ad15bbad725759c0289a122787ef', class: "fb-popover__body" }, index.h("slot", { key: 'a58c06abd74e80cb5c041eb95f4b4938ebd1dae8' })))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "open": [{
...
const FbSwitch = class {
    ...
    render() {
        const hasHelper = !!this.helperText;
        return (index.h(index.Host, { key: 'b7e6238aacf1c654665ae27ebc8cff5a7e4dc88e' }, index.h("div", { key: 'b41a7018ca86930b381ab7867b9ae008d878d642', class: "fb-switch-wrapper" }, index.h("label", { key: '27a5136fd7e1254d0bca6e0f87396f6f72e7e1ad', htmlFor: this.switchId, class: { 'fb-switch-label': true, 'disabled': this.disabled } }, index.h("input", { key: '8679f2cc0c6bb681049cf0565c01793e40b2879c', id: this.switchId, type: "checkbox", role: "switch", checked: this.checked, disabled: this.disabled, "aria-checked": this.checked ? 'true' : 'false', "aria-describedby": hasHelper ? this.helperId : null, class: "native-switch", onChange: (e) => {
                this.checked = e.target.checked;
                this.fbChange.emit(this.checked);
            } }), index.h("span", { key: '17c012b3587cf5bd7e4391fbaf1fa88c7477babc', "aria-hidden": "true", class: { 'switch-track': true, 'on': this.checked } }, index.h("span", { key: 'ae0dcab4bbc1e894a40b41ed8745be1a18c4ba3b', class: "switch-thumb" })), this.label && index.h("span", { key: '7c2ab00b3d0f6475d610bea0781c551a0096f86b', class: "label-text" }, this.label)), hasHelper && (index.h("div", { key: '0616644749fb204cf9a556c43e11d882195e7198', id: this.helperId, class: "fb-helper" }, this.helperText)))));
    }
};
...
const FbTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '40ad7fb5108d391946d87e2462e9237fa72097ba' }, index.h("span", { key: '9ac62f2b8225b59d9ecb4b285bee5d750483000b', class: "fb-tooltip-wrapper", onMouseEnter: () => this.show(), onMouseLeave: () => this.hide(), onFocusin: () => this.show(), onFocusout: () => this.hide() }, index.h("span", { key: '8050ae1a404ba4e1c9c11e6ea61c833b9bae4511', "aria-describedby": this.visible ? this.tooltipId : null }, index.h("slot", { key: 'b5712cbc43937ff0ea319c4dca3b56e86ead4e57' })), this.visible && (index.h("span", { key: '947741ae81c6326b7e71b556c6af3ef52c408447', id: this.tooltipId, role: "tooltip", class: `fb-tooltip fb-tooltip--${this.placement}` }, this.content)))));
    }
    get el() { return index.getElement(this); }
};
