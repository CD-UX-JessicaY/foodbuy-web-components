...
const FbCombobox = class {
    ...
    render() {
        ...
        const activeOptId = this.open && this.focusedIndex >= 0 && enabledFiltered[this.focusedIndex]
            ...
            : undefined;
        return (index.h(index.Host, { key: 'd4494e36d7dadee8ef5d93fd2fdcf022f70b62fc' }, index.h("div", { key: '11b6eac0ac6071de8041eb896ee626fcdb238b23', class: "fb-combobox-wrapper" }, fieldHelpers.renderFieldLabel(this.label, this.required, this.inputId, this.labelId), index.h("div", { key: 'ced7e117a304055a7da17d4c74a610209c281a51', class: "fb-combobox-container" }, index.h("div", { key: 'e8c459c74b81d64fccaaa2b61e487f6f88ca1e04', class: {
                'fb-combobox-field': true,
                [`size-${this.size}`]: true,
                'state-error': this.isError,
                'state-disabled': this.isDisabled,
                'is-open': this.open,
            } }, index.h("span", { key: '85543003465e2df1705571d653de28d41eb9b072', class: "search-icon", "aria-hidden": "true" }, index.h("svg", { key: '0ed25b269e61468d232f6b3d6b89dede2e48be7a', width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("circle", { key: 'f980031d16e8668698a6c453304d78a37ea1ac71', cx: "11", cy: "11", r: "8" }), index.h("path", { key: 'a2e73c8c79ee79321df265c768734d2392ffbb13', d: "m21 21-4.35-4.35" }))), index.h("input", { key: '5539aad77fbca166af2889f9f2efd33f69bc2b2e', id: this.inputId, ref: el => this.inputEl = el, type: "text", role: "combobox", "aria-autocomplete": "list", "aria-expanded": this.open ? 'true' : 'false', "aria-controls": this.listboxId, "aria-activedescendant": activeOptId, "aria-required": this.required ? 'true' : null, "aria-invalid": this.isError ? 'true' : null, "aria-describedby": hasHelper ? this.helperId : null, "aria-labelledby": this.label ? this.labelId : null, disabled: this.isDisabled, value: this.inputValue, placeholder: this.placeholder, class: "native-input", autoComplete: "off", spellcheck: false, onInput: this.handleInput, onFocus: this.handleFocus, onBlur: this.handleBlur, onKeyDown: this.handleKeyDown }), showClear && (index.h("button", { key: '22556e42e892806dbbd7175d7039898bbc1e98d7', type: "button", class: "icon-btn clear-btn", "aria-label": "Clear", tabIndex: -1, onMouseDown: e => e.preventDefault(), onClick: this.handleClear }, index.h("svg", { key: 'ec1f0cd7229e965757d633a710f36e59dd4e7d09', width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2.2", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: '77bf31d6e10ebbb782d9e17f3fd3758d7b3f4307', d: "M18 6L6 18M6 6l12 12" })))), index.h("span", { key: '4563e3199732bacd78da009c76ef9d8a3c99ce46', class: { 'chevron': true, 'chevron--open': this.open }, "aria-hidden": "true" }, index.h("svg", { key: '08970c657adf649d4f041b412952df1617baf2a2', width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { key: '2e21457f0667c3de03fe37a8ef750caee48300cc', d: "M6 9l6 6 6-6" })))), this.open && (index.h("ul", { key: 'cc06b2bf6aee7415bcebc89e5ea60435381159d0', id: this.listboxId, role: "listbox", "aria-label": this.label || 'Options', class: "fb-listbox" }, filtered.length === 0 ? (index.h("li", { class: "fb-option fb-option--empty", role: "option", "aria-disabled": "true" }, this.noResultsText)) : (filtered.map(opt => {
            var _a;
